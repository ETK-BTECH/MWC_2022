...
class Font5x7():
    ...
    def PrintString(self,display,string,xpos,ypos,size,color):
        if size == 2:
            spacing = 12
        elif size == 1:
            spacing = 6
            ...
            spacing = 18
        for i in string:
            self.PrintChar(display,i,xpos,ypos,size,color)
            xpos+=spacing
            
    def PrintStringV(self, display,string,xpos,ypos,size,color):
        if size == 2:
            spacing = 14
        elif size == 1:
            spacing = 6
            ...
            spacing = 18
        for i in string:
            self.PrintCharV(display,i,xpos,ypos,size,color)
            ypos-=spacing
            
    def PrintChar(self,display,letter,xpos,ypos,size,color):
        origin = xpos
        if letter == '°':
            ...
            character = self.cmap[index] #this is our char...
    ...
    def PrintCharV(self,display,letter,xpos,ypos,size,color):
